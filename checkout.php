...
<head>
<meta charset="utf-8">
<title>Medicoz | Health and Medical HTML Template | Checout</title>
                ...
                <div class="nav-outer">
                    <nav class="nav main-menu">
                        <ul class="navigation" id="navbar">
								...
								<li class=""><a href="about-us_patient.php">About Us</a></li>
...
<section class="checkout-page">
    <div class="auto-container">
        ...
        <div class="payment-box">
                    ...
                    <ul>
                        <li>
                            <div class="radio-option">
                                ...
                                <label for="payment-1"><strong>Cash on Appointment</strong><span>Pay at the clinic upon arrival.</span></label>
                            </div>
                        </li>
                        <li>
                            <div class="radio-option">
                                <input type="radio" name="payment-group" id="payment-2">
                                <label for="payment-2"><strong>Credit Card</strong><span>Pay securely online using your credit card.</span></label>
                            </div>
                        </li>
                    </ul>
                </div>
            ...
            <div class="lower-box">
                <a href="#" class="theme-btn btn-style-one"><span class="btn-title">Confirm Appointment</span></a>
            </div>
        </div>
    </div>
</section>
